...
2. **Microsoft Advertising:** validate company, industry, and job-function profile criteria for the authorized account. [Microsoft ProfileCriterion reference](https://learn.microsoft.com/en-us/advertising/campaign-management-service/profilecriterion?view=bingads-13)
